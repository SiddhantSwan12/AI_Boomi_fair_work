...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        hero:           ["clamp(2.25rem, 5vw, 4rem)",   { lineHeight: "1.1",  letterSpacing: "0", fontWeight: "800" }],
        "hero-sub":     ["clamp(1rem, 1.5vw, 1.2rem)",  { lineHeight: "1.7",  fontWeight: "400" }],
        "section-title":["clamp(1.6rem, 3vw, 2.5rem)",  { lineHeight: "1.15", letterSpacing: "0", fontWeight: "700" }],
        metric:         ["clamp(1.75rem, 3vw, 2.5rem)", { lineHeight: "1",    letterSpacing: "0", fontWeight: "700" }],
      },
      spacing: {
        section:     "96px",
        "section-lg":"128px",
