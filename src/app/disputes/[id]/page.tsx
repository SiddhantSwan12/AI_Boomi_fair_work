...
export default function DisputeDetailsPage() {
        ...
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
                ...
                <div className="container mx-auto px-6 py-12 text-center">
                    <p className="text-slate-600 dark:text-slate-400">Dispute not found</p>
                </div>
            </div>
        );
    }
    ...
    const timelineEvents = [
        ...
        },
        {
            ...
            description: dispute.jurors?.length > 0
                ? `${dispute.jurors.length} jurors have been selected to arbitrate`
                : "Selecting anonymous jurors from the staked pool",
            timestamp: dispute.jurors?.length > 0 ? "Jurors Selected" : "Pending",
            status: dispute.jurors?.length > 0 ? "completed" as const : "pending" as const,
        },
        {
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="w-full lg:w-96 space-y-6">
                            ...
                            <JuryVotingPanel
                                ...
                                jurors={dispute.jurors?.map((j: any) => j.juror_address) || []}
                                votes={dispute.votes?.map((v: any) => ({
                                    juror: v.juror,
                                    decision: v.decision,
